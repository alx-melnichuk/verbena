...
mod tests {
    ...
    async fn test_get_ws_chat_ews_join_ews_leave_err() {
        ...
        let stream_id_wrong = ChatMessageDbTest::stream_ids().last().unwrap().clone() + 1;
        ...
        let stream_id_wrong2 = ChatMessageDbTest::stream_ids().last().unwrap().clone() + 1;
        ...
        // let stream3a_id = ChatMessageDbTest::stream_ids().get(2).unwrap().clone(); // live: false
        ...
        // let stream3b_id = ChatMessageDbTest::stream_ids().get(2).unwrap().clone(); // live: false
        ...
        let num_token1b = config_jwt::tests::get_num_token(USER1_ID);
        ...
        let token2a = config_jwt::tests::get_token(user2a_id);
        #[rustfmt::skip]
        ...
        let token3a = config_jwt::tests::get_token(user3a_id);
        #[rustfmt::skip]
        ...
        let num_token3b = config_jwt::tests::get_num_token(user3b_id + 1);
