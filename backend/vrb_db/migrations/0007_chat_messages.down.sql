-- Remove entities: "chat_messages", "chat_message_logs", "blocked_users".

-- **

-- Removing entity: "blocked_users".
...
-- Removing entity: chat_message_logs.
