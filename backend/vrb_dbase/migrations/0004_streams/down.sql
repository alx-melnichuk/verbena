...
/* Drop stored function to get an entity from the "stream_tags". */
DROP FUNCTION IF EXISTS get_stream_tags;

/* Drop stored function to filter the entity from "streams" and "stream_tags" according to the conditions. */
...
/* Drop stored function to get an entity from the "streams" and "stream_tags". */
DROP FUNCTION IF EXISTS get_stream_and_stream_tag;

-- ( 5 ) --
-- ( 4 ) --

/* Drop stored function to delete the entity in "streams" and "stream_tags". */
DROP FUNCTION IF EXISTS delete_stream_and_stream_tag;

/* Drop stored function to modify the entry in "streams" and "stream_tags". */
DROP FUNCTION IF EXISTS modify_stream_and_stream_tag;

/* Drop stored function to add a new entry to "streams" and "stream_tags". */
DROP FUNCTION IF EXISTS create_stream_and_stream_tag;

/* Drop stored function to delete the entity in "streams" and "stream_tags". */
DROP FUNCTION IF EXISTS delete_stream_tag_deprecated;

/* Drop stored function to modify the entry in "stream_tags". */
DROP FUNCTION IF EXISTS modify_stream_tag;

-- ( 4 ) --
-- ( 3 ) --

/* Drop trigger "trg_aft_del_link_stream_tags_to_streams". */
...
/* Drop trigger "trg_aft_upd_link_stream_tags_to_streams". */
...
/* Drop trigger "trg_aft_ins_link_stream_tags_to_streams". */
