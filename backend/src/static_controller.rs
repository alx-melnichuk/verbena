...
pub async fn index_root(config_app: web::Data<config_app::ConfigApp>) -> Result<HttpResponse, Error> {
    ...
    let app_backend02: Vec<&str> = vec![
        ...
        "actix-cors = \"0.7.0\" - Cross-Origin Resource Sharing (CORS) controls for Actix Web",
        "actix-files = \"0.6.6\" - Static file serving for Actix Web",
        "actix-multipart = \"0.7.2\" - Multipart form support for Actix Web",
        "actix-web = { version = \"4.9.0\", features = [\"openssl\"] } - Fast web framework",
        "argon2 = \"0.5.3\" - Implementation of password hashing function",
        "chrono = { version = \"0.4.40\", features = [\"serde\"] } - Date and time library",
        "diesel = { version = \"2.2.7\", features = [\"postgres\", \"r2d2\", \"chrono\"] } - ORM and query builder",
        "diesel-derive-enum = { version = \"2.1.0\", features = [\"postgres\"] }",
        "diesel_migrations = \"2.2.0\" - Migration management for diesel",
        "dotenv = \"0.15.0\" - Loads environment variables from a .env file",
        "email_address = \"0.2.9\" - Email verification",
        "env_logger = \"0.11.6\" - A logging implementation for `log`",
        "futures-util = \"0.3.31\" - Common utilities and extension traits for the futures-rs library",
        "handlebars = \"6.3.1\" - Handlebars templating implemented",
        "image = \"0.24.9\" - An Image Processing Library",
        "jsonwebtoken = \"9.3.1\" - Create and parses JWT (JSON Web Tokens)",
        "lettre = { version = \"0.11.14\", features = [\"tokio1\", \"tokio1-native-tls\"] } - Mail client",
        "log = \"0.4.26\" - Provides a single API abstraction for logging",
        "mime = \"0.3.17\" - Support MIME (Media Types)",
        "openssl = \"0.10.71\" - HTTPS encryption library for websites",
        "r2d2 = \"0.8.10\" - Pool database",
        "rand = \"0.9.0\" - Random number generators",
        "regex = \"1.11.1\" - An implementation of regular expressions",
        "serde = { version = \"1.0.218\", features = [\"derive\"] } - serialization/deserialization",
        "serde_json = \"1.0.139\" - A JSON serialization file format",
        "utoipa = { version = \"5.3.1\", features = [\"chrono\", \"actix_extras\"] } - Auto-generated OpenAPI documentation",
        "utoipa-swagger-ui = { version = \"9.0.0\", features = [\"actix-web\"] } - Implementing Swagger via a web server",
        "utoipa-redoc = { version = \"6.0.0\", features = [\"actix-web\"] } - Implementation of Redoc via a web server",
        "utoipa-rapidoc = { version = \"6.0.0\", features = [\"actix-web\"] } - Implementation of Rapidoc via a web server",
    ];
