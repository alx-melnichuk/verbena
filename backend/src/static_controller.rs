...
pub async fn index_root(config_app: web::Data<config_app::ConfigApp>) -> Result<HttpResponse, Error> {
    ...
    let app_backend02: Vec<&str> = vec![
        ...
        "diesel = { version = \"2.2.6\", features = [\"postgres\", \"r2d2\", \"chrono\"] } - ORM and query builder",
        ...
        "env_logger = \"0.11.5\" - A logging implementation for `log`",
        "futures-util = \"0.3.31\" - Common utilities and extension traits for the futures-rs library",
        "handlebars = \"6.2.0\" - Handlebars templating implemented",
        "image = \"0.24.9\" - An Image Processing Library",
        "jsonwebtoken = \"9.3.0\" - Create and parses JWT (JSON Web Tokens)",
        "lettre = { version = \"0.11.11\", features = [\"tokio1\", \"tokio1-native-tls\"] } - Mail client",
        "log = \"0.4.22\" - Provides a single API abstraction for logging",
        "mime = \"0.3.17\" - Support MIME (Media Types)",
        "openssl = \"0.10.68\" - HTTPS encryption library for websites",
        "r2d2 = \"0.8.10\" - Pool database",
        "rand = \"0.9.0\" - Random number generators",
        "regex = \"1.11.1\" - An implementation of regular expressions",
        "serde = { version = \"1.0.216\", features = [\"derive\"] } - serialization/deserialization",
        "serde_json = \"1.0.133\" - A JSON serialization file format",
        "utoipa = { version = \"5.2.0\", features = [\"chrono\", \"actix_extras\"] } - Auto-generated OpenAPI documentation",
