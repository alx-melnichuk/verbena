...
/*
  ...
  Dynamic height (with automatic adjustment)
    <app-field-textarea wd100 [label]=""description2"" [maxLen]="2" [minLen]="120"
        [minRows]="1"
        [maxRows]="4">
    </app-field-textarea>
*/
@Component({
    ...
    providers: [
        { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => FieldTextarea), multi: true },
