...
import {
    Component, ViewEncapsulation, ChangeDetectionStrategy, OnChanges, Input, Output, EventEmitter, HostBinding, inject, SimpleChanges
} from "@angular/core";
...
export class FieldFileUpload implements OnChanges {
    @Input()
    ...
    public files: File[] = [];
    public id = `file-drop-id${uniqueIdCounter++}`;
