...
@Component({
    ...
    providers: [
        { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => FieldPassword), multi: true },
        { provide: NG_VALIDATORS, useExisting: forwardRef(() => FieldPassword), multi: true },
    ],
})
export class FieldPassword implements OnChanges, ControlValueAccessor, Validator {
    @Input()
