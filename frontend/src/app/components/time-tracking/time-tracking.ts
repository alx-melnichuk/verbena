...
import {
    Component, ViewEncapsulation, ChangeDetectionStrategy, OnChanges, OnDestroy, Input, signal, SimpleChanges, computed
} from "@angular/core";
import { TranslatePipe } from "@ngx-translate/core";
import { LOCALE_UK } from "../../common/locale-srv";
...
export class TimeTracking implements OnChanges, OnDestroy {
    @Input()
    public id = `tm-trc-id${uniqueIdCounter++}`;
    @Input()
