...
@Component({
    ...
    exportAs: "appPanelStreamCalendar",
    standalone: true,
    imports: [CommonModule, MatDatepickerModule, CalendarHeader],
    templateUrl: "./panel-stream-calendar.html",
    styleUrls: ["./panel-stream-calendar.scss", "./panel-stream-calendar-emblem.scss"],
