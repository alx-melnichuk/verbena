...
export class CalendarHandler {
    ...
    public async getCalendarInfoForPeriod(
        ...
        try {
            ...
            const response = await this.streamSrv.getStreamsPeriod(search);
    ...
    public async getListEventsForDate(
        ...
        try {
            const response = await this.streamSrv.getStreamsEvent({ userId, starttime, page, limit: SC_DEFAULT_LIMIT });
